...
import h5py
import tables
from utils.hase.hdgwas.tools import Timer, Checker, study_indexes, Mapper, HaseAnalyser, merge_genotype, Reference, \
    timing, check_np, check_converter
...
if __name__ == '__main__':
    ...
    parser.add_argument('-intercept', type=str, default='y', choices=['y', 'n'],
                        help='include intercept to regression, default yes')
